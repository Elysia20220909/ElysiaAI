...
export const config = {
	...
	llmProviderPriority: splitCsvEnv(
		getEnv(
			"LLM_PROVIDER_PRIORITY",
			"fastapi,ollama,llama-cpp,openai-compatible",
		),
	),
	llmAllowCloudFallback: getEnv("LLM_ALLOW_CLOUD_FALLBACK", "false") === "true",
	llamaCppBaseUrl: getEnv("LLAMA_CPP_BASE_URL", "http://127.0.0.1:8080"),
	llamaCppApiKey: getEnv("LLAMA_CPP_API_KEY", ""),
	llamaCppModel: getEnv("LLAMA_CPP_MODEL", ""),
	openaiCompatibleBaseUrl: getEnv("OPENAI_COMPATIBLE_BASE_URL", ""),
	openaiCompatibleApiKey: getEnv("OPENAI_COMPATIBLE_API_KEY", ""),
	openaiCompatibleModel: getEnv("OPENAI_COMPATIBLE_MODEL", ""),
