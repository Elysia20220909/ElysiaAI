...
def boot_sequence():
    ...
    # 美しいプログレスバーによる起動演出
    tasks = ["Initializing System Core...", "Loading Soul Engine (Elysia & Cyrene)...", "Mounting Memory Vault..."]
    for _task in track(tasks, description="[cyan]Booting ElysiaAI OS...[/cyan]"):
        time.sleep(0.5)
...
[/bold hot_pink]"""
                console.print(
                    Panel(letter, title="[bold cyan]💌 記憶の臨界点 -特別な手紙-[/bold cyan]", border_style="magenta")
                )
