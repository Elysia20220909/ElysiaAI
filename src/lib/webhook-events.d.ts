export type WebhookEvent = "user.registered" | "user.login" | "chat.message" | "feedback.created" | "error.critical" | "backup.completed" | "rate_limit.exceeded" | "system.health_check_failed";
