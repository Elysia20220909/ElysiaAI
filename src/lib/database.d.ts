...
export declare const userService: {
	create(data: { username: string; passwordHash: string; role?: string }): Promise<{
		id: string;
		username: string;
		role: string;
		createdAt: Date;
...
export declare const tokenService: {
	create(data: { token: string; userId: string; expiresAt: Date }): Promise<{
		token: string;
		id: string;
		userId: string;
		createdAt: Date;
...
export declare const chatService: {
	createSession(data: { userId?: string; mode?: string }): Promise<{
		id: string;
		userId: string | null;
		mode: string;
		createdAt: Date;
	...
	getSession(id: string): Promise<
		...
		| null
	>;
	addMessage(data: { sessionId: string; role: string; content: string }): Promise<{
		id: string;
		role: string;
		content: string;
		createdAt: Date;
...
export declare const voiceService: {
	create(data: { username?: string; text: string; emotion: string; audioUrl?: string }): Promise<{
		text: string;
		id: string;
