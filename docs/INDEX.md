...
Optimized entry point for Claude Token Optimizer. Load only the file needed for the task.
...
| Codex / WinUI automated setup, Japanese | `docs/CODEX_AUTOMATED_SETUP.ja.md` |
...
Historical or superseded notes belong in `docs/archive/` and should not be loaded at startup.
