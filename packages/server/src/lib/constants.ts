...
export const CONFIG = {
	...
	LLM_PROVIDER_PRIORITY: config.llmProviderPriority,
	LLM_ALLOW_CLOUD_FALLBACK: config.llmAllowCloudFallback,
	LLAMA_CPP_BASE_URL: config.llamaCppBaseUrl,
	LLAMA_CPP_API_KEY: config.llamaCppApiKey,
	LLAMA_CPP_MODEL: config.llamaCppModel,
	OPENAI_COMPATIBLE_BASE_URL: config.openaiCompatibleBaseUrl,
	OPENAI_COMPATIBLE_API_KEY: config.openaiCompatibleApiKey,
	OPENAI_COMPATIBLE_MODEL: config.openaiCompatibleModel,
