...
async def run_sandbox(target_prompt_file: str = "elysia.prompt.txt"):
    ...
    results = {"status": "success", "timestamp": datetime.datetime.now().isoformat(), "steps": []}
    ...
    async with httpx.AsyncClient() as client:
        ...
        for i, q in enumerate(questions, 1):
            ...
            step_result = {"question": q, "answer": answer, "evaluation": evaluation, "emotion": emotion}
