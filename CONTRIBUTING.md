...
2. Use **Conventional Commits** (e.g., `feat:`, `fix:`, `docs:`, `chore:`) for all commit messages.
3. Update documentation if you are adding or changing features.
4. Ensure CI passes on your PR.

## 🏷️ Versioning

ElysiaAI follows **Semantic Versioning (SemVer)**.
- Major: Breaking changes
- Minor: New features (backwards compatible)
- Patch: Bug fixes (backwards compatible)

Releases are managed via GitHub Tags (`vX.Y.Z`).
