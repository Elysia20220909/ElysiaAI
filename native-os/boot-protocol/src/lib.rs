...
impl BootMode {
    pub const fn from_raw(value: u32) -> Option<Self> {
        match value {
            ...
            73 => Some(Self::InferenceQuota),
            74 => Some(Self::InferenceQuotaDenied),
            75 => Some(Self::SizedInference0),
            76 => Some(Self::SizedInference1),
            77 => Some(Self::SizedInference2),
            78 => Some(Self::SizedInference3),
            79 => Some(Self::SizedInference4),
            80 => Some(Self::SizedInference5),
            81 => Some(Self::SizedInference6),
            82 => Some(Self::SizedInference7),
            83 => Some(Self::SizedInference8),
