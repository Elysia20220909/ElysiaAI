...
fn mode() -> BootMode {
    match option_env!("ELYSIA_BOOT_MODE").unwrap_or("normal") {
        ...
        "infer-quota-approve" => BootMode::InferenceQuota,
        "infer-quota-denied" => BootMode::InferenceQuotaDenied,
        "infer-size-0" => BootMode::SizedInference0,
        "infer-size-1" => BootMode::SizedInference1,
        "infer-size-2" => BootMode::SizedInference2,
        "infer-size-3" => BootMode::SizedInference3,
        "infer-size-4" => BootMode::SizedInference4,
        "infer-size-5" => BootMode::SizedInference5,
        "infer-size-6" => BootMode::SizedInference6,
        "infer-size-7" => BootMode::SizedInference7,
        "infer-size-8" => BootMode::SizedInference8,
