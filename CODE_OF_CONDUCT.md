...
**概要**: 互いを尊重し、安全で包摂的な場を守ります。違反は迅速かつ公正に対応し、再発防止を図ります。連絡先: [security@elysia.ai](mailto:security@elysia.ai)
...
Wiki の編集、Issue、およびその他の貢献を削除、編集、または拒否する権利と責任を持ち、
...
[security@elysia.ai](mailto:security@elysia.ai).
